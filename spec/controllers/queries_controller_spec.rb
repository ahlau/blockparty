  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved query as @query" do
        ...
        post :create, {:query => { "mail_server_id" => "invalid value" }}, valid_session
        assigns(:query).should be_a_new(Query)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested query" do
        ...
        Query.any_instance.should_receive(:update_attributes).with({ "mail_server_id" => "1" })
        put :update, {:id => query.to_param, :query => { "mail_server_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the query as @query" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Query.any_instance.stub(:save).and_return(false)
        put :update, {:id => query.to_param, :query => { "mail_server_id" => "invalid value" }}, valid_session
        assigns(:query).should eq(query)
      end
